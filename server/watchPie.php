...
<script type="text/javascript">
	...
	for(i=0; i<response.result.player.length; i++){
	    ...
	    seriesPie.push({data:[ ["Call", 1],
		    ["Fold", 1],
		    ["Raise", 1] ], name:player["name"]});
	}

	alert(seriesPie.toSource());
    ...
    //function setup()
    {
      ...
      setupGraph();
      observe();
      document.getElementById("actions").innerHTML = "<div id=\"world1\">world1</div> <div id=\"world2\">world2</div> <div id=\"world3\">world3</div>";
    }
